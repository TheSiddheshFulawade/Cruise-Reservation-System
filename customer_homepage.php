...
<html>
	...
	<body>
		...
		<table cellpadding="5">
			<tr>
				<td class="admin_func"><a href="book_tickets.php"><i class="fa fa-ship" aria-hidden="true"></i> Book Cruise Tickets</a>
				</td>
			</tr>
			<tr>
				<td class="admin_func"><a href="view_booked_tickets.php"><i class="fa fa-ship" aria-hidden="true"></i> View Booked Cruise Tickets</a>
				</td>
			</tr>
			<tr>
				<td class="admin_func"><a href="cancel_booked_tickets.php"><i class="fa fa-ship" aria-hidden="true"></i> Cancel Booked Cruise Tickets</a>
				</td>
			</tr>
		</table>
