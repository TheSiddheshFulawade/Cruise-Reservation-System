...
-- Procedures
--
CREATE DEFINER=`siddhesh`@`localhost` PROCEDURE `GetFlightStatistics` (IN `j_date` DATE)  BEGIN
...
--
DELIMITER $$ 
grant all privileges on airline_reservation.* to 'epiz_32829486'@'sql211.epizy.com'
