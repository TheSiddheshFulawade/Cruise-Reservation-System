...
<html>
	...
	<body>
		...
		<form action="add_flight_details_form_handler.php" method="post">
			<h2>ENTER THE CRUISE SCHEDULE DETAILS</h2>
			<?php
				if(isset($_GET['msg']) && $_GET['msg']=='success')
				{
					echo "<strong style='color: green'>The Cruise Schedule has been successfully added.</strong>
						<br>
						<br>";
				}
				else if(isset($_GET['msg']) && $_GET['msg']=='failed')
				{
					echo "<strong style='color: red'>*Invalid Cruise Schedule Details, please enter again.</strong>
						<br>
						<br>";
				}
			?>
			<table cellpadding="5">
				<tr>
					<td class="fix_table">Cruise Number</td>
				</tr>
				<tr>
			...
			<table cellpadding="5">
				<tr>
					<td class="fix_table">Cruise ID</td>
				</tr>
				<tr>
					<td class="fix_table">
